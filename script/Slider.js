class Slider {
  ...
  init() {
    this.draggable.addEventListener('pointerdown', this.pointerDownHandler);
  }

  posRouting = () => {
    this.posRoutings.forEach((v, k) => {
